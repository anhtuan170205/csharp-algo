...
Each case starts with a line containing an integer **n** denoting the number of rungs in the ladder. The next line contains **n** space separated integers, **r1, r2, ..., rn** (**1 ≤ r1 < r2 < ... < rn ≤ 10^7**) denoting the heights of the rungs from the ground. For all cases, **1 ≤ n ≤ 10**, except **5** cases where **10 ≤ n ≤ 10^5**.
